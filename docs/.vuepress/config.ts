...
export default defineUserConfig({
  base: "/",
  lang: "zh-CN",
  title: "front-end-interview-docs",
  description: "Front-end interview questions documents.",
  ...
  theme: plumeTheme({
    ...
    hostname: "https://interview.zhenghaoyang.cn",

    /* 文档仓库配置，用于 editLink */
    docsRepo: "https://github.com/zhenghaoyang24/front-end-interview-docs",
    docsDir: "docs",
    docsBranch: "master",
